...
import type {AltRPCEvent} from "@/connect/events/rpc/altRPCEvent";
...
export class altLog {
  ...
  static get logLevel(): string {
    // @ts-ignore
    return window.altLogLevelGlobal || import.meta.env.VITE_ALT_LOG_LEVEL || import.meta.env.MODE === "development" ? "info" : "warning"
  }
